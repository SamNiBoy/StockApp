...
public class PriceBoxBrkUpBuyPointSelector implements IBuyPointSelector {

	static Logger log = Logger.getLogger(PriceBoxBrkUpBuyPointSelector.class);
	
    private boolean sim_mode;
    private String selector_name = "PriceBoxBrkUpBuyPointSelector";
    private String selector_comment = "";
    private int pre_trend = 0; //1: asc, 0: NaN, -1: desc
    
    
    public PriceBoxBrkUpBuyPointSelector(boolean sm)
    {
        sim_mode = sm;
    }
	...
	public boolean isGoodBuyPoint(Stock2 stk, ICashAccount ac) {
        ...
        if ((sbs == null || !sbs.is_buy_point) && stk.priceBreakingBoxBtnEdge(3)) {
        	log.info("stock:" + stk.getID() + " price breaking box bottom at:" + stk.getDl_dt().toString() + ", good to buy.");
			stk.setTradedBySelector(this.selector_name);
			stk.setTradedBySelectorComment("stock:" + stk.getID() + " price breaking box bottom at:" + stk.getDl_dt().toString() + ", good to buy.");
        	return true;
        }
