...
public class STConstants {
	...
	public static final double MAX_LOST_PCT_FOR_SELL_MODE = -0.08;
	public static final double MAX_GAIN_PCT_FOR_DISABLE_SELL_MODE = 0.04;
    
	public static final double BASE_TRADE_THRESH = 0.05;
	
	public static final double TOP_INCSTOP_BASE_TRADE_THRESH = 0.07;
}
