	...
	public static boolean loadStocksForTrade() {
		...
		try {
			...
			sql = "select s.*, u.* " + "from usrStk s," + "     usr u " + "where s.openID = u.openID "
					...
					+ "and s.suggested_by in ('" + STConstants.openID +"','" + STConstants.SUGGESTED_BY_FOR_SYSTEM_GRANTED + "','" + STConstants.SUGGESTED_BY_FOR_SYSTEM_READ_FOR_TRADE + "') and u.buy_sell_enabled = 1";
